...
export const ExperiencesQuickAccess = () => {
  return (
    <div className="py-6">
      <h2 className="text-xl font-gasoek text-green-700 mb-4">Acceso Rápido</h2>
      
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
        <QuickAccessItem icon={Calendar} label="Próximas Experiencias" />
        <QuickAccessItem icon={MapPin} label="Por Ubicación" />
        <QuickAccessItem icon={Users} label="Comunidades" />
        <QuickAccessItem icon={Tag} label="Categorías" />
      </div>
    </div>
  );
};
