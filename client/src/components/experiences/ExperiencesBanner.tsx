...
export const ExperiencesBanner = () => {
  return (
      ...
      <div className="relative z-20 h-full flex flex-col justify-center px-6">
        <div className="max-w-2xl">
          ...
          <p className="text-sm md:text-base text-white/90 mb-3 max-w-xl">
            Descubre aventuras únicas que te conectan con la naturaleza, culturas locales y prácticas sostenibles
          </p>
          
          <Button className="bg-green-600 hover:bg-green-700 text-white">
            Explorar Experiencias <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
        </div>
      </div>
    </div>
