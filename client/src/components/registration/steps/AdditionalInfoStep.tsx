...
const AdditionalInfoStep = ({
  ...
  const renderAttendeeFields = () => (
    <div className="space-y-4">
      <p className="font-bold text-lg mb-4" style={{ color: '#cad95e' }}>¿Qué tipo de experiencias te interesan?</p>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex items-center space-x-3">
          ...
          />
          <Label htmlFor="ecotourism" className="font-medium text-lg" style={{ color: '#cad95e' }}>Ecoturismo</Label>
        </div>
        <div className="flex items-center space-x-3">
          <Checkbox
            id="communityTourism"
          ...
          />
          <Label htmlFor="communityTourism" className="font-medium text-lg" style={{ color: '#cad95e' }}>Turismo comunitario</Label>
        </div>
        <div className="flex items-center space-x-3">
          <Checkbox
            id="culturalTourism"
          ...
          />
          <Label htmlFor="culturalTourism" className="font-medium text-lg" style={{ color: '#cad95e' }}>Turismo cultural y creativo</Label>
        </div>
        <div className="flex items-center space-x-3">
          <Checkbox
            id="slowTravel"
          ...
          />
          <Label htmlFor="slowTravel" className="font-medium text-lg" style={{ color: '#cad95e' }}>Workation / Slow Travel</Label>
        </div>
        <div className="flex items-center space-x-3">
          <Checkbox
            id="workshops"
          ...
          />
          <Label htmlFor="workshops" className="font-medium text-lg" style={{ color: '#cad95e' }}>Formación y talleres</Label>
        </div>
      </div>
    </div>
  );
  ...
  const renderSponsorFields = () => (
    <div className="space-y-4">
      <p className="font-bold text-lg mb-4" style={{ color: '#cad95e' }}>¿Qué tipo de participación te interesa?</p>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex items-center space-x-3">
          <Checkbox
          ...
          />
          <Label htmlFor="sponsorActivities" className="font-medium text-lg" style={{ color: '#cad95e' }}>Patrocinar actividades o escenarios</Label>
        </div>
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor="installStand" className="font-medium text-lg" style={{ color: '#cad95e' }}>Instalar un stand</Label>
        </div>
        <div className="flex items-center space-x-3">
          <Checkbox
            id="brandExposure"
          ...
          />
          <Label htmlFor="brandExposure" className="font-medium text-lg" style={{ color: '#cad95e' }}>Difundir marca en app y redes</Label>
        </div>
        <div className="flex items-center space-x-3">
          <Checkbox
            id="productSupport"
          ...
          />
          <Label htmlFor="productSupport" className="font-medium text-lg" style={{ color: '#cad95e' }}>Apoyar con productos/servicios</Label>
        </div>
      </div>

      <div>
        <Label htmlFor="proposal" className="font-bold text-lg" style={{ color: '#cad95e' }}>¿Tienes una propuesta específica?</Label>
        <Textarea
          id="proposal"
          name="proposal"
  ...
  const renderEcosystemFields = () => (
    <div className="space-y-4">
      <div className="flex items-center space-x-3">
        ...
        />
        <Label htmlFor="wantsSeal" className="font-medium text-lg" style={{ color: '#cad95e' }}>¿Quieres optar al Sello NATUR?</Label>
      </div>

      <div>
        <Label htmlFor="servicesOffered" className="font-bold text-lg" style={{ color: '#cad95e' }}>¿Qué servicios o experiencias ofreces?*</Label>
        <Textarea
          id="servicesOffered"
      ...
      <div>
        <Label htmlFor="certifications" className="font-bold text-lg" style={{ color: '#cad95e' }}>¿Ya cuentas con certificaciones previas? (opcional)</Label>
        <Input
          id="certifications"
          name="certifications"
  ...
  const renderStartupFields = () => (
    <div className="space-y-4">
      <div>
        <Label htmlFor="startupName" className="font-bold text-lg" style={{ color: '#cad95e' }}>Nombre de tu startup*</Label>
        <Input
          id="startupName"
          name="startupName"
      ...
      <div>
        <Label htmlFor="problemSolved" className="font-bold text-lg" style={{ color: '#cad95e' }}>¿Qué problema resuelves en el turismo sostenible?*</Label>
        <Textarea
          id="problemSolved"
          name="problemSolved"
      ...
      <div>
        <Label htmlFor="startupWebsite" className="font-bold text-lg" style={{ color: '#cad95e' }}>Sitio web o redes sociales (opcional)</Label>
        <Input
          id="startupWebsite"
          name="startupWebsite"
      ...
      <div className="space-y-4">
        <p className="font-bold text-lg mb-4" style={{ color: '#cad95e' }}>¿Qué tipo de apoyo te interesa?</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex items-center space-x-3">
            <Checkbox
              id="visibility"
            ...
            />
            <Label htmlFor="visibility" className="font-medium text-lg" style={{ color: '#cad95e' }}>Visibilidad en el festival</Label>
          </div>
          <div className="flex items-center space-x-3">
            <Checkbox
              id="marketplace"
            ...
            />
            <Label htmlFor="marketplace" className="font-medium text-lg" style={{ color: '#cad95e' }}>Espacio en el marketplace</Label>
          </div>
          <div className="flex items-center space-x-3">
            <Checkbox
              id="networking"
            ...
            />
            <Label htmlFor="networking" className="font-medium text-lg" style={{ color: '#cad95e' }}>Networking con aliados</Label>
          </div>
          <div className="flex items-center space-x-3">
            <Checkbox
              id="funding"
            ...
            />
            <Label htmlFor="funding" className="font-medium text-lg" style={{ color: '#cad95e' }}>Acceso a fondos o inversión</Label>
          </div>
          <div className="flex items-center space-x-3">
            <Checkbox
              id="incubation"
            ...
            />
            <Label htmlFor="incubation" className="font-medium text-lg" style={{ color: '#cad95e' }}>Programas de incubación/aceleración</Label>
          </div>
        </div>
      </div>
    </div>
